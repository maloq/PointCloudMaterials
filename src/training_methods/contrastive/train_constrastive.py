...
import wandb
import time
from src.training_methods.contrastive.dimenet_module import DimeNetContrastive
...
@hydra.main(version_base=None, config_path=os.path.join(os.getcwd(),"configs"), config_name="contrastive_64")
