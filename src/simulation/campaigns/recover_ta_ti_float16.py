...
def main():
    ...
    config = json.loads((REPO / 'docs/simulations/ti_ta_crystallization/technical/ta.json').read_text())
    ...
    sequence(REPO / 'docs/simulations/ti_ta_crystallization/technical/ta.json',
             REPO / 'docs/simulations/ti_ta_crystallization/technical/ti.json', resume_ta=True)
