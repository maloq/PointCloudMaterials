...
# Keep the public class identity recorded by qualified potential reports and
# saved calculators. Producer hashes track this implementation file separately;
# this alias does not authorize an exact-resume source transition.
VerletSkinMACECalculator.__module__ = (
