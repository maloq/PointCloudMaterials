...
class Group(nn.Module):  # FPS + KNN
    ...
    def forward(self, xyz):
        '''
            ...
            center : B G 3
        '''
        batch_size, point_size, _ = xyz.shape
        # fps the centers out
        ...
        idx_base = torch.arange(0, batch_size, device=xyz.device).view(-1, 1, 1) * point_size
        idx = idx + idx_base
        idx = idx.view(-1)
        neighborhood = xyz.view(batch_size * point_size, -1)[idx, :]
