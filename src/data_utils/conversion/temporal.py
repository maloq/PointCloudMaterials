...
def convert_replica(replica_dir: Path, *, delete_source: bool = False) -> dict[str, Any]:
...
def main(argv=None) -> None:
    ...
    for raw_root in args.campaign_roots:
        ...
        for replica_index, replica_dir in enumerate(replicas):
            ...
            reports.append(convert_replica(replica_dir, delete_source=args.delete_source))
        campaign_report = {
            "format": FORMAT_NAME,
            "schema_version": 1,
            "state": "complete",
            ...
            "deleted_source_bytes": sum(
                ...
                for report in reports if report["source_lammpstrj"]["deleted"]
            ),
        ...
        json.dumps(
            {
                ...
                "freed_bytes": sum(report["deleted_source_bytes"] for report in campaign_reports) - total_binary,
            },
            sort_keys=True,
        ),
        flush=True,
