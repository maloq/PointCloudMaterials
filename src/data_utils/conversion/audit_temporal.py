#!/usr/bin/env python3
"""Verify converted non-shooting trajectories and their source provenance."""
...
def audit_campaign(root: Path, *, require_source_deleted: bool = False) -> dict[str, int | str | bool]:
    ...
    for binary_dir in binary_dirs:
        ...
        if source_record["deleted"]:
            deleted_bytes += int(source_record["size_bytes"])
    ...
    return {
        ...
        "freed_bytes": deleted_bytes - binary_bytes,
        "all_sources_deleted": all_deleted,
    }
