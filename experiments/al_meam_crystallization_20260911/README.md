...
Prepared 2026-09-11. Research question: generate a continuous pure-Al
...
python scripts/run_lammps_campaign.py elemental run \
  --config experiments/al_meam_crystallization_20260911/al.json
```
...
`preflight.py` is an experiment-specific validation recipe using the maintained
...
`al.json`, this README and `preflight.py` are experiment records. Elemental runner
