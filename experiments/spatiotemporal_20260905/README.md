...
```bash
conda run -n pointnet python src/research/spatiotemporal/prepare_spatiotemporal_vicreg_views.py --help
...
conda run -n pointnet python src/research/spatiotemporal/analyze_spatiotemporal_vicreg_results.py \
  --experiment-root /path/to/completed_experiment
conda run -n pointnet python src/research/spatiotemporal/run_geoframe_spatiotemporal_post_analysis.py \
  --root /path/to/structural_analysis
conda run -n pointnet python src/research/spatiotemporal/compare_spatiotemporal_static_clustering.py \
  --root /path/to/structural_analysis
conda run -n pointnet python src/research/spatiotemporal/run_spatiotemporal_objective_comparison.py \
...
is [post_analysis.yaml](technical/post_analysis.yaml): paths are relative to `--root`.
...
```bash
python src/research/spatiotemporal/compare_spatiotemporal_objectives.py \
...
python src/research/spatiotemporal/run_geoframe_spatiotemporal_post_analysis.py \
...
python src/research/spatiotemporal/branch_temporal_comparison.py \
  --root output/geoframe_v2_spatiotemporal_analysis_20260905
python src/research/spatiotemporal/summarize_full_static_analysis.py \
  --root output/geoframe_v2_spatiotemporal_analysis_20260905
```
