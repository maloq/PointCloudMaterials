...
def test_metric_documents_match_implementation_and_travel_with_table(tmp_path):
    assert set(check_metric_docs()) == {'analysis', 'topology', 'forecast', 'forecast_context', 'forecast_crystallization', 'forecast_spatial_mixture', 'aggregation', 'mace_encoder_diagnostics', 'mace_tda_ridge_audit', 'mace_context', 'mace_context_smoothness', 'mace_context_recovery', 'mace_velocity', 'mace_data_amount', 'mace_causal', 'mace_causal_comparison', 'hardware_benchmark', 'mace_causal_runtime'}
