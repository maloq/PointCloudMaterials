...
and cosine weights equal to one through radius 6 and zero at radius 8. There
...
Table export: 2026-09-18T22:39:41.738879+00:00. The machine-readable values retain full precision; blank values mean undefined or unrecorded, never zero. Nested metric names preserve the producer's grouping. The implementation hashes are in `../technical/metric-contract.json`.
