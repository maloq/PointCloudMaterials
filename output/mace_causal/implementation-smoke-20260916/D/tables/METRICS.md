...
the vanishing age envelope near its boundary. The sequence adapter verifies the retained position/velocity arrays and label
...
the pilot uses 0.75, 1.5 and 3 ps futures, the last exceeding observed history.
...
Table export: 2026-09-16T18:26:00.023104+00:00. The machine-readable values retain full precision; blank values mean undefined or unrecorded, never zero. Nested metric names preserve the producer's grouping. The implementation hashes are in `../technical/metric-contract.json`.
