# Al · original 48 ps shooting, eight shots per parent

[All datasets](../README.md) · [Browsable card](al_meam_position_shooting_70304_400-500K_48ps_8shots_20260830-de1b3e62.html) · [Full metadata](../records/al_meam_position_shooting_70304_400-500K_48ps_8shots_20260830-de1b3e62.json)
...
- ID: `al_meam_position_shooting_70304_400-500K_48ps_8shots_20260830`
- Materials: Al
- Classification: **research**; role: raw_dynamics
- Location: `/work/PERSO/vmorozov/simulations/al_meam_position_shooting_70304_400-500K_48ps_8shots_20260830`
- Present on this machine: True
- Potentials: Lee–Shim–Baskes 2003 Al 2NN-MEAM
- Complete binary records with arrays present: 320; these are not independent-source counts.
- Stored frames: 51520; duplicate-group records: 0
- Allocated storage, excluding registered nested datasets: 82.639 GiB
...
```json
{
  "title": "Al \u00b7 original 48 ps shooting, eight shots per parent",
  "materials": [
    "Al"
  ],
  "role": "raw_dynamics",
  ...
  "evidence": [
    "${dataset:al_meam_position_shooting_70304_400-500K_48ps_8shots_20260830}"
  ],
  "potential_ids": [
    "al-lee2003-meam"
  ],
...
| velocity_seed | [101485013, 102979543, 106686085, 111585476, 112506268, 125590272, 125956988, 127716657, 129649220, 13012607, 130542394, 134962386] … (328 values; see JSON) |
...
All 1329 producer records, their hashes, field paths and current array schemas: [metadata JSON](../records/al_meam_position_shooting_70304_400-500K_48ps_8shots_20260830-de1b3e62.json).
