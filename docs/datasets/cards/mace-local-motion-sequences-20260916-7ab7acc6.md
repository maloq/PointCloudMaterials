# mace-local-motion-sequences-20260916

[All datasets](../README.md) · [Browsable card](mace-local-motion-sequences-20260916-7ab7acc6.html) · [Full metadata](../records/mace-local-motion-sequences-20260916-7ab7acc6.json)

Previously unregistered derived data. Inspect schemas, source plans and cache protocol before reuse.

- ID: `mace-local-motion-sequences-20260916`
- Materials: Al
- Classification: **derived**; role: training_cache
- Location: `/home/ids/vmorozov/training-cache/mace-local-motion-sequences-20260916`
- Present on this machine: True
- Potentials: Unknown / not applicable
- Complete binary records with arrays present: 0; these are not independent-source counts.
- Stored frames: 0; duplicate-group records: 0
- Allocated storage, excluding registered nested datasets: 0.176 GiB
...
```json
{
  "title": "mace-local-motion-sequences-20260916",
  "role": "training_cache",
  ...
  "evidence": [
    "${dataset:mace-local-motion-sequences-20260916}"
  ]
}
```
...
| timestep_fs | [2.0, 3.0] |
| frame_count | [112, 113, 118, 119, 120, 128, 130, 135, 140, 142, 144, 149] … (74 values; see JSON) |
| temperature_K | [400.0, 450.0, 500.0, 510.0, 520.0] |
| atom_count | [70304] |

## Evidence

All 1126 producer records, their hashes, field paths and current array schemas: [metadata JSON](../records/mace-local-motion-sequences-20260916-7ab7acc6.json).
