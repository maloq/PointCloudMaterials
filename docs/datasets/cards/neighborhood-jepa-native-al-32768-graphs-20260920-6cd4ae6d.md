# Expanded native Al JEPA 32,768 anchors: graphs

[All datasets](../README.md) · [Browsable card](neighborhood-jepa-native-al-32768-graphs-20260920-6cd4ae6d.html) · [Full metadata](../records/neighborhood-jepa-native-al-32768-graphs-20260920-6cd4ae6d.json)
...
- ID: `neighborhood-jepa-native-al-32768-graphs-20260920`
- Materials: Al
- Classification: **derived**; role: training_cache
- Location: `/home/ids/vmorozov/training-cache/neighborhood_jepa/native-al-32768-graphs-20260920`
- Present on this machine: True
- Potentials: Lee–Shim–Baskes 2003 Al 2NN-MEAM
- Complete binary records with arrays present: 0; these are not independent-source counts.
- Stored frames: 0; duplicate-group records: 0
- Allocated storage, excluding registered nested datasets: 9.382 GiB
...
```json
{
  "title": "Expanded native Al JEPA 32,768 anchors: graphs",
  "materials": [
    "Al"
  ],
  "role": "training_cache",
  ...
  "evidence": [
    "${dataset:neighborhood-jepa-native-al-32768-graphs-20260920}/manifest.json",
...
| Field | Values |
| --- | --- |
| seed | [1000416918, 1002813770, 1005769362, 1006197591, 1007638866, 1010615687, 1010759934, 1011296975, 1011405658, 101501871, 1015288621, 1019893882] … (1227 values; see JSON) |
...
All 616 producer records, their hashes, field paths and current array schemas: [metadata JSON](../records/neighborhood-jepa-native-al-32768-graphs-20260920-6cd4ae6d.json).
