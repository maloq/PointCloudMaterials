# memory-al-precision-20260917-source002-T500

[All datasets](../README.md) · [Browsable card](memory-al-precision-20260917-source002-T500-41b210a5.html) · [Full metadata](../records/memory-al-precision-20260917-source002-T500-41b210a5.json)
...
- ID: `memory-al-precision-20260917-source002-T500`
- Materials: Al
- Classification: **review_required**; role: raw_dynamics
- Location: `/store/PERSO/vmorozov/simulations/memory-al-precision-20260917-source002-T500`
...
```json
{
  "title": "memory-al-precision-20260917-source002-T500",
  "materials": [
    "Al"
  ],
  "role": "raw_dynamics",
  ...
  "evidence": [
    "${dataset:memory-al-precision-20260917-source002-T500}"
  ]
}
```
...
| barostat_ps | [3.0] |
| pressure_bar | [0.0] |
| root_lineage | ["independent_melt_746219836"] |
| parent_trajectory_id | [null] |
| temperature_K | [500.0] |
| split | ["train"] |
| preparation_seed | [746219836] |
| velocity_seed | [622469642] |
| frame_count | [2561] |
...
All 5 producer records, their hashes, field paths and current array schemas: [metadata JSON](../records/memory-al-precision-20260917-source002-T500-41b210a5.json).
