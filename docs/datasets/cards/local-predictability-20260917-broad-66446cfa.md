# Al · full-timeline physical descriptors

[All datasets](../README.md) · [Browsable card](local-predictability-20260917-broad-66446cfa.html) · [Full metadata](../records/local-predictability-20260917-broad-66446cfa.json)

Previously unregistered derived data. Inspect schemas, source plans and cache protocol before reuse.

- ID: `local-predictability-20260917-broad`
- Materials: Al
- Classification: **derived**; role: training_cache
- Location: `/home/ids/vmorozov/training-cache/local-predictability-20260917-broad`
- Present on this machine: True
- Potentials: Lee–Shim–Baskes 2003 Al 2NN-MEAM
- Complete binary records with arrays present: 0; these are not independent-source counts.
- Stored frames: 0; duplicate-group records: 0
- Allocated storage, excluding registered nested datasets: 1.064 GiB
...
```json
{
  "title": "Al \u00b7 full-timeline physical descriptors",
  "role": "training_cache",
  ...
  "evidence": [
    "${dataset:local-predictability-20260917-broad}"
  ],
  "potential_ids": [
    "al-lee2003-meam"
  ]
...
All 151 producer records, their hashes, field paths and current array schemas: [metadata JSON](../records/local-predictability-20260917-broad-66446cfa.json).
