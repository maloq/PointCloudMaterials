...
- Allocated storage, excluding registered nested datasets: 0.473 GiB
...
All 825 producer records, their hashes, field paths and current array schemas: [metadata JSON](../records/relaxed-encoder-expanded-20260921-955f1e16.json).
