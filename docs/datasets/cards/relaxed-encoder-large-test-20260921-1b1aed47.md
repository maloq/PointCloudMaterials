# Dense fixed-grid Al relaxed crystallization evaluation_cache

[All datasets](../README.md) · [Browsable card](relaxed-encoder-large-test-20260921-1b1aed47.html) · [Full metadata](../records/relaxed-encoder-large-test-20260921-1b1aed47.json)
...
- ID: `relaxed-encoder-large-test-20260921`
- Materials: Al
- Classification: **research**; role: evaluation_cache
- Location: `/home/ids/vmorozov/training-cache/relaxed_encoder/large-test-20260921`
- Present on this machine: True
- Potentials: Lee–Shim–Baskes 2003 Al 2NN-MEAM
- Complete binary records with arrays present: 0; these are not independent-source counts.
- Stored frames: 0; duplicate-group records: 0
- Allocated storage, excluding registered nested datasets: 0.983 GiB
...
```json
{
  "title": "Dense fixed-grid Al relaxed crystallization evaluation_cache",
  "materials": [
    "Al"
  ],
...
All 3930 producer records, their hashes, field paths and current array schemas: [metadata JSON](../records/relaxed-encoder-large-test-20260921-1b1aed47.json).
