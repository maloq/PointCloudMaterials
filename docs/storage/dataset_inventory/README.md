...
Inventory scope: what datasets and derived products occupy `/home/ids/vmorozov`, how
much storage do they use, and which physical potentials/protocols and completed
sample counts do they represent?

Detailed findings: [readable inventory](../../simulations/inventory_20260913.md).
...
This README and scope JSON are operational documentation. Generated size/manifest
