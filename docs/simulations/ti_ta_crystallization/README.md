...
conda run -n pointnet python scripts/run_lammps_campaign.py elemental sequence \
  --ta-config docs/simulations/ti_ta_crystallization/technical/ta.json \
  --ti-config docs/simulations/ti_ta_crystallization/technical/ti.json
```
...
[the cleanup record](../../ids_storage_cleanup_20260907.md) and
...
conda run -n pointnet python scripts/run_lammps_campaign.py elemental sequence \
  --ta-config docs/simulations/ti_ta_crystallization/technical/ta.json \
  --ti-config docs/simulations/ti_ta_crystallization/technical/ti.json --resume-ta
```
...
```bash
PYTHONPATH=. conda run -n pointnet python src/simulation/campaigns/recover_ta_ti_float16.py
```
...
python scripts/run_lammps_campaign.py elemental branch \
  --config docs/simulations/ti_ta_crystallization/technical/ti_early_slurm.json \
  --parents docs/simulations/ti_ta_crystallization/technical/ti_early_parents.json --index INDEX
```
...
```bash
python scripts/run_lammps_campaign.py elemental branch \
  --config docs/simulations/ti_ta_crystallization/technical/ti_shooting_round2_20260909.json \
  --parents docs/simulations/ti_ta_crystallization/technical/ti_shooting_round2_parents_20260909.json \
  --index INDEX
```
