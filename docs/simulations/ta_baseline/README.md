...
```bash
conda run -n pointnet python src/simulation/campaigns/ta_initial_branch.py --help
```
...
[spatiotemporal study](../../geoframe_spatiotemporal_vicreg_20260905.md) and
[simulation context](../../simulation_context_for_agents.md).
