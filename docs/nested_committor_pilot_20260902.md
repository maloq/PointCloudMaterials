...
PYTHONPATH=. python scripts/run_nested_committor.py \
  --config /store/PERSO/vmorozov/projects/PointCloudMaterials-retention-20260913/experiments/shooting_ablation_20260901/technical/nested_committor_geoframe_v2_20260902.yaml
```
