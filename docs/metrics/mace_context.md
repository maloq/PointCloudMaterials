...
The graph API also exposes an optional concatenated center feature for the
separate information-recovery experiment. Default 256-channel calculations and
the pilot's metric definitions remain unchanged.
