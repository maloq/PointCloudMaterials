...
`experiments/spatiotemporal_20260905/prepare_spatiotemporal_vicreg_views.py --config JSON`
...
Detailed MACE analysis artifacts now live on IDS. The two MACE templates set
