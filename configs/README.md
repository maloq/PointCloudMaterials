...
- `analysis/crystallization_figures.json`: paper-style PNG forecasts, UMAP and real spatial-context illustrations from completed development-selected models.
