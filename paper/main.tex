...
\author{Vsevolod Morozov\inst{1,2} \corr \and
...
\toctitle{Self-Supervised Rotation-Invariant Representations for Unsupervised Motif Discovery in Molecular Dynamics}

\tocauthor{Vsevolod Morozov, Emilie Devijver, Charlotte Laclau, Paul Krzakala, and Noel Jakse}
